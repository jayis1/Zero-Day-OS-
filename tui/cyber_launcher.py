...
TOOLS = {
    "WIFI": [
        ...
        {"name": "WPS Pixie Dust",    "desc": "WPS offline attack + PIN brute",  "cmd": "sudo wps-attack wlan1",             "need_root": True},
        {"name": "Probe Dump",        "desc": "Passive MAC→SSID probe map",      "cmd": "sudo wifi-probe-dump wlan1 60",     "need_root": True},
        {"name": "Karma AP",          "desc": "Clone most-probed SSID rogue AP", "cmd": "sudo wifi-karma-ap wlan1 wlan0",    "need_root": True},
        {"name": "Evil Twin",         "desc": "Rogue AP with captive portal",    "cmd": "sudo wifi-evil-twin",               "need_root": True,  "args": ["AP_IFACE", "INET_IFACE", "ESSID"]},
        {"name": "Crack Handshake",   "desc": "Crack .cap (4-tier: defaults→rockyou)", "cmd": "wifi-autocrack",              "need_root": False, "args": ["CAP_FILE"]},
    ...
    "NET": [
        ...
        {"name": "VLAN Hop",          "desc": "VLAN hopping: double-tag + DTP",  "cmd": "sudo vlan-hop detect eth0",         "need_root": True},
        {"name": "DHCP Starve",      "desc": "Exhaust DHCP pool (random MACs)",  "cmd": "sudo dhcp-attack starve eth0",      "need_root": True},
        {"name": "DHCP Snoop",       "desc": "Passive client/hostname map",      "cmd": "sudo dhcp-attack snoop eth0",       "need_root": True},
        {"name": "SNMP Scan",        "desc": "Community brute + MIB walk",       "cmd": "sudo snmp-scan auto",               "need_root": True},
        {"name": "HTTP Probe",        "desc": "Find web services + juicy paths",  "cmd": "http-probe",                        "need_root": False, "args": ["TARGET"]},
        {"name": "HTTP Probe Auto",   "desc": "Auto-discover from last nmap scan", "cmd": "http-probe auto",                   "need_root": False},
    ...
    "PAYLD": [
        ...
        {"name": "Crack WiFi .cap",   "desc": "Tiered auto-crack: defaults→rockyou→rules→mask", "cmd": "wifi-autocrack crack", "need_root": False, "args": ["CAP_FILE"]},
        {"name": "Pass Spray SSH",    "desc": "Lockout-safe password spray",     "cmd": "pass-spray ssh",                    "need_root": False, "args": ["TARGET"]},
        {"name": "Pass Spray SMB",    "desc": "SMB/NTLM password spray",         "cmd": "pass-spray smb",                    "need_root": False, "args": ["TARGET"]},
        {"name": "Pass Spray Auto",   "desc": "Spray all discovered services",   "cmd": "pass-spray auto",                   "need_root": False},
        {"name": "Kerberoast",       "desc": "TGS/AS-REP hash extraction",       "cmd": "kerberoast auto",                   "need_root": False, "args": ["TARGET"]},
        {"name": "Engagement Clean", "desc": "Wipe forensic artifacts (opsec)", "cmd": "sudo engagement-clean select",      "need_root": True},
        {"name": "Post Harvest",      "desc": "Grab SSH keys, creds, history",   "cmd": "post-harvest all",                  "need_root": False},
